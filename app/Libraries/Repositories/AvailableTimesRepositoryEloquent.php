...
/**
 * Class AvailableTimesRepositoryEloquent.
 *
 * @package namespace App\Libraries\Repositories;
 */
class AvailableTimesRepositoryEloquent extends BaseRepository implements UsersRepository
{
