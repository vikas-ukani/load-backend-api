 ...
 */
class BookmarkRepositoryEloquent extends BaseRepository implements UsersRepository
{
    ...
    protected function commonFilterFn(&$value, $input)
    {
        ...
        /** professional_id and professional_ids wise filter */
        if (isset($input['professional_id'])) {
            $value = $value->where('professional_id', $input['professional_id']);
        }
        if (isset($input['professional_ids']) && count($input['professional_ids']) > 0) {
            $value = $value->whereIn('professional_id', $input['professional_ids']);
        }
