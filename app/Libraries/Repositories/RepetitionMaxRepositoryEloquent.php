...
/**
 * Class RepetitionMaxRepositoryEloquent.
 *
 * @package namespace App\Libraries\Repositories;
 */
class RepetitionMaxRepositoryEloquent extends BaseRepository implements UsersRepository
{
    ...
    protected function commonFilterFn(&$value, $input)
    {
        ...
        // if (isset($input['estimated_weight'])) {
        //     $value = $value->where('estimated_weight', $input['estimated_weight']);
        // }
        // if (isset($input['actual_weight'])) {
        //     $value = $value->where('actual_weight', $input['actual_weight']);
        // }
