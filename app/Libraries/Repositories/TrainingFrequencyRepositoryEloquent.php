...
class TrainingFrequencyRepositoryEloquent extends BaseRepository implements UsersRepository
{
    ...
    {
        return TrainingFrequencies::class;
    }
    ...
    protected function commonFilterFn(&$value, $input)
    {
        ...
        if (isset($input['search'])) {
            $value = $this->customSearch($value, $input, ['title', 'code', 'is_active']);
        }
    ...
    /**
     * getDetails => get details by listing.
     *
     * @param  mixed $input
     *
     * @return void
