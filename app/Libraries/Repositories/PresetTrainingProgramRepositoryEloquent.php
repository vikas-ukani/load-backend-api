...
use App\Models\PresetTrainingProgram;
use Prettus\Repository\Eloquent\BaseRepository;
use Prettus\Repository\Criteria\RequestCriteria;
use App\Libraries\RepositoriesInterfaces\UsersRepository;

/**
 * Class PresetTrainingProgramRepositoryEloquent.
 *
 * @package namespace App\Libraries\Repositories;
 */
class PresetTrainingProgramRepositoryEloquent extends BaseRepository implements UsersRepository
{
    ...
    {
        return PresetTrainingProgram::class;
    }
    ...
    protected function commonFilterFn(&$value, $input)
    {
        ...
        if (isset($input['search'])) {
            $value = $this->customSearch($value, $input, ['title', 'subtitle', 'is_active', 'status', 'title']);
        }
     ...
     *
     * @param  mixed $value => main object
     * @param  mixed $input => conditions array
     *
     * @return void
     */
    ...
    /**
     * getDetailsByInput => get details bt input for back side query's
     *
     * @param  mixed $input
     *
     * @return void
