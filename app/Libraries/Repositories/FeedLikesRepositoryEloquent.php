...
/**
 * Class FeedLikesRepositoryEloquent.
 *
 * @package namespace App\Libraries\Repositories;
 */
class FeedLikesRepositoryEloquent extends BaseRepository implements UsersRepository
{
    ...
    protected function commonFilterFn(&$value, $input)
    {
        ...
        if (isset($input['search'])) {
            $value = $this->customSearch($value, $input, ['feed_id', 'user_ids']);
        }
