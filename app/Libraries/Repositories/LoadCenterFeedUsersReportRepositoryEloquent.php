 ...
 */
class LoadCenterFeedUsersReportRepositoryEloquent extends BaseRepository implements UsersRepository
{
    ...
    {
        return LoadCenterFeedUsersReport::class;
    }
    ...
    public function checkAlreadyAddedReport($input = null)
    {
        $value = $this->makeModel();
        
        $value = $value->where('feed_id', $input['feed_id'])
            ->where('feed_report_id', $input['feed_report_id'])
