...
use App\Models\LoadCenterFeedReports;
 ...
 */
class LoadCenterFeedReportsRepositoryEloquent extends BaseRepository implements UsersRepository
{
    ...
    {
        return LoadCenterFeedReports::class;
    }
