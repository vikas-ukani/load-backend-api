...
/**
 * Class TargetedMusclesRepositoryEloquent.
 *
 * @package namespace App\Libraries\Repositories;
 */
class TargetedMusclesRepositoryEloquent extends BaseRepository implements UsersRepository
{
