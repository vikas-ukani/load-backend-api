...
/**
 * Class UserFollowersRepositoryEloquent.
 *
 * @package namespace App\Libraries\Repositories;
 */
class UserFollowersRepositoryEloquent extends BaseRepository implements UsersRepository
{
