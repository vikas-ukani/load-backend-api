...
use App\Models\SettingRaceDistance;
...
/**
 * Class SettingRaceDistanceRepositoryEloquent.
 *
 * @package namespace App\Libraries\Repositories;
 */
class SettingRaceDistanceRepositoryEloquent extends BaseRepository implements UsersRepository
{
    ...
    {
        return SettingRaceDistance::class;
    }
