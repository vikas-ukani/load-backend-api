...
use App\Models\TrainingLogStyle;
...
/**
 * Class TrainingLogStyleRepositoryEloquent.
 *
 * @package namespace App\Libraries\Repositories;
 */
class TrainingLogStyleRepositoryEloquent extends BaseRepository implements UsersRepository
{
