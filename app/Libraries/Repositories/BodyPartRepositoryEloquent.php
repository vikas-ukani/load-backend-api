...
/**
 * Class BodyPartRepositoryEloquent.
 *
 * @package namespace App\Libraries\Repositories;
 */
class BodyPartRepositoryEloquent extends BaseRepository implements UsersRepository
{
    ...
    protected function commonFilterFn(&$value, $input)
    {
        ...
        /** check for parent record or not */
        ...
        if (isset($input['is_parent']) && $input['is_parent'] == false) {
            $value = $value->whereNotNull('parent_id');
        }
